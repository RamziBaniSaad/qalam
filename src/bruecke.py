...
# unten wird still verworfen, und das ist richtig -- aber davor hat mich das Ohr
...
# zustande."
#
# Hier ist EINE der beiden Stellen, an denen es feststeht: das Gehoerte kam aus
# meinem eigenen Lautsprecher, also war der Stopp ein Fehlalarm. Gehandelt wird
# in der Sprech-Zentrale -- die zweite Stelle sitzt im Assistenten, und beide
# sollen dieselbe Bremse teilen (siehe sprechzentrale.weiterreden_nach_fehlalarm).
def _weiterreden_nach_fehlalarm():
    try:
        import sprechzentrale
        sprechzentrale.weiterreden_nach_fehlalarm('Brücke')
